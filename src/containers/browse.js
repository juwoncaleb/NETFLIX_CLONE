...
export function BrowseContainer({ slides }) {
    ...
    useEffect(() => {
        ...
        const fuse = new Fuse(slideRows, {keys : ['data.description', 'data.genre', 'data.genre'], 
    }); 
        ...
        <>
            ...
            <Header src="joker1" dontShowOnSmallViewPort>
                ...
                <Header.Feature>
                    ...
                    <Header.Text>
                        Forever alone in a crowd, failed comedian Arthur Fleck seeks connection as he walks the streets <br></br> of Gotham
                        City. Arthur wears two masks -- the one he paints for his day job  <br></br>  as a clown, and the guise he projects in a
